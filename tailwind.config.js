module.exports = {
  content: ['./layouts/**/*.html', './content/**/*.{html,md}', './themes/blowfish/layouts/**/*.html', './themes/blowfish/content/**/*.{html,md}', './themes/blowfish/node_modules/tw-elements/js/**/*.js'],
  ...
  plugins: [require('@tailwindcss/typography'), require('@tailwindcss/forms'), require('tailwind-scrollbar')({ preferredStrategy: 'pseudoelements' })],
}
